...
// import databaseDashboard from "../../assets/icon//DashboardPageLogo/databasePage.svg";
...
import CreateDatabase from "./modalCrateDatabase/CreateDatabase";
    ...
    <>
      <div className="py-6 flex justify-between px-6 mt-6 font-sp-pro-text-regular">
        <div className="flex px-2 gap-x-2 pb-8">
          ...
          <img src={databaseDashboard} alt="" className="h-10 mt-1 " />
        </div>
            ...
            <div className="">
              ...
              >
                <div className="flex gap-x-2">
                  <BsDatabaseAdd size={17} className="" />
                  <p className="font-sp-pro-text-medium">Create Database</p>
                </div>
              </button>
            </div>
          </div>
