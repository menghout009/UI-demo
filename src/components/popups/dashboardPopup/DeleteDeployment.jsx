...
export default function DeleteDeployment({
  isDeleteDeploy,
  setDeleteDeploy,
  deployments,
  setDeployments,
  ...
  const handleDelete = () => {
    const newData = deployments.filter((d) => d.id !== isId);
    setDeployments(newData);
    closeModal()
  };
  ...
  return (
    <>
      <Transition appear show={isDeleteDeploy} as={Fragment}>
                  ...
                  <div className="mt-2">
                    <div className="flex flex-col  text-text-color ">
                      ...
                      <div className="text-center flex flex-col gap-y-2 text-text-color">
                        ...
                        <p>
                          This deployment depend on other deployment{" "}
