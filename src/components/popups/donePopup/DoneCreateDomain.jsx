...
import domainIcon from "../../../assets/popup-icon/domain.png";


export default function DoneCreateDomain({ isDoneCreate, setDoneCreate }) {
                    ...
                    <div className="flex flex-col  text-text-color ">
                      ...
                      <div className="text-center flex flex-col gap-y-3 text-text-color">
                        <p className="font-sp-pro-text-medium text-md">
                          Set domain name successfully
                        </p>
                        <div className="flex justify-center items-center gap-x-3">
                          <p className="text-sm">
                            Succfully set domain to{" "}
                            <span className="font-sp-pro-text-medium text-sm">
                              AutoPilot React{" "}
                            </span>
                          </p>
                          <img src={domainIcon} alt="" className="h-8 w-8" />
