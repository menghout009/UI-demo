...
import databaseIcon from "../../../assets/popup-icon/database.png";


export default function DoneCreateDatabase({
    isDoneCreate,
    setDoneCreate,
}) {
                    ...
                    <div className="flex flex-col  text-text-color ">
                      ...
                      <div className="text-center flex flex-col gap-y-3 text-text-color">
                        ...
                        <div className="flex justify-center items-center gap-x-3">
                          <p className="text-sm">
                            Succfully deploy database{" "}
                            <span className="font-sp-pro-text-medium text-sm">
                              AutoPilot database{" "}
                            </span>
                          </p>
                          <img src={databaseIcon} alt="" className="h-7 w-7 mb-3" />

                        </div>
                      </div>

                      <div className="font-sp-pro-text-regular flex gap-x-10 justify-center py-3 mt-4">
                        <button
                          type="button"
