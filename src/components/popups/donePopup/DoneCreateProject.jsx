...
import teamProjectImg from "../../../assets/images/projectLogo/newProject.svg";
import { useDispatch } from "react-redux";
import { changeCreateSuccess } from "../../../redux/slice/projectSlice";


export default function DoneCreateProject({ isDoneCreate, setDoneCreate }) {
                  ...
                  <div className="mt-2">
                    <div className="flex flex-col  text-text-color ">
                      ...
                      <div className="text-center flex flex-col gap-y-2 text-text-color">
                        ...
                        <img src={teamProjectImg} alt="" className="h-24 w-32" />
